...
public class CustomerDAO {
	...
	public String  findById(String name, String email) throws SQLException {
	...
	public String  findByPw(String name, String email, String id) throws SQLException {

		String sql = "select * from customer where name = ? and email = ? and id = ?";
		...
		try {
			...
			e.printStackTrace();
			System.out.println("findByPw 실패");
		}
