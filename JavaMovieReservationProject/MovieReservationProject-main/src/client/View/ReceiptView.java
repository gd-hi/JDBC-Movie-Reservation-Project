...
public class ReceiptView extends JFrame {
	...
	public void buildGUI() {
		...
		titleLabel.setFont(new Font("굴림", Font.BOLD, 26));
		...
		englishNameLabel.setFont(new Font("굴림", Font.BOLD, 11));
		englishNameLabel.setBounds(12, 278, 314, 14);
		panel.add(englishNameLabel);

		JLabel dayLabel = new JLabel(day +" " + time+"회" );
		...
		JLabel roomLabel = new JLabel(roomNumber+"(1층)   "+ seatStr+"    총(" +person+"명)");
		roomLabel.setFont(new Font("굴림", Font.BOLD, 14));
		...
		lblNewLabel_7_1.setFont(new Font("굴림", Font.BOLD, 13));
		lblNewLabel_7_1.setBounds(12, 545, 314, 28);
		panel.add(lblNewLabel_7_1);

		JLabel theatherLabel = new JLabel("MYTICKET "+ theatherName);
		theatherLabel.setBounds(12, 175, 160, 15);
		panel.add(theatherLabel);

		JLabel theatherLabel_1 = new JLabel("032-123-1234");
